      ...
      <div className="story-content-flex">
        ...
        <div className="story-text-side">
          ...
          <p className="story-description">
            في عام 2025 ، رأينا مشكلة تحتاج إلى حل. كل يوم، كانت أطنان من المنتجات الجيده تُهدر بينما يكافح الناس لتحمل تكلفة المنتجات الجيدة. أنشأنا "نعمه" لسد هذه الفجوة، وتحويل الهدر إلى فرصة.
          </p>
          <div className="story-mission-box">
            مهمتنا هي إنشاء نظام تقليل هدر مستدام حيث لا شيء يُهدر والجميع يستفيد.
          </div>
        </div>
        ...
        <div className="story-cards-side">
          <div className="story-white-card">
            ...
            <div className="card-text">
              ...
              <p>كل منتج محفوظة هي خطوة نحو مستقبل أكثر استدامة.</p>
            </div>
          </div>
          ...
          <div className="story-white-card">
            ...
            <div className="card-text">
              ...
              <p>استخدام التكنولوجيا لحل المشاكل الحقيقية في هدر المنتجات.</p>
            </div>
          </div>
        </div>
