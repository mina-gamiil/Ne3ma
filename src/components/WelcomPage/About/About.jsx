      ...
      <div className="story-content-flex">
        ...
        <div className="story-text-side">
          ...
          <p className="story-description">
            في عام 2025 ، رأينا مشكلة تحتاج إلى حل. كل يوم، كانت أطنان من الطعام الجيد تُهدر بينما يكافح الناس لتحمل تكلفة الوجبات الجيدة. أنشأنا "نعمه" لسد هذه الفجوة، وتحويل الهدر إلى فرصة.
          </p>
